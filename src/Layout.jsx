...
import { Home, Dumbbell, TrendingUp, Users, User, Shield, Apple, Sparkles, Menu, X, LogOut, Trophy, Award, Headphones, BarChart3, Video } from "lucide-react";
...
export default function Layout({ children, currentPageName }) {
  ...
  const buildSideMenuItems = () => {
    ...
    items.push(
      ...
      { name: "Análise de Vídeo", path: createPageUrl("VideoAnalysis"), icon: Video },
