...
export default function BarcodeScanner() {
  ...
  // Scanner de código de barras usando câmera (simplificado - input manual)
  const startScanner = async () => {
    // Por limitações de bibliotecas no Base44, vamos usar input manual
    // mas mostrar uma interface amigável
    setIsScanning(true);
  };
